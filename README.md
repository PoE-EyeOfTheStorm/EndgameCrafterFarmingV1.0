A filter tailored to endgame farmers and crafters based on PoEDave's Fubgun UberStrict filter, with several additions that make finding craftable items easier.
